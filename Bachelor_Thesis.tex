...
\begin{titlepage}
	...
	\vspace{1.5cm}
	{\huge Surface functionalization of H-terminated diamond with NH and NH$_2$ on the $(1,  0,  0)$, $(1,  1,  0)$ and $(1,  1, 1)$ surface planes using Density Functional Theory\par}
	\vspace{2cm}
