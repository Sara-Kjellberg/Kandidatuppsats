...
\begin{table}[!h] \caption{Adsorption energies for different possible products with nitrogen and a diamond surface at the (1 1 1), (1 1 0) and (1 0 0) orientation. The General Gradient Approximation (GGA) is used with the Perdow-Burke-Erzhov (PBE) density functional. The on-top position on the (1 0 0) surface had problem converging and where hence forced to be less accurate with a cutoff energy of 2E-4 eV instead of 2E-6 as with the other rest of the calculations.} \label{adsorptionEnergies}
