...
\usepackage{adjustbox} %adjusting figures and tables
...
\begin{figure} \captionsetup{width=.8\linewidth} \caption{The optimized structures of the (1 0 0)-plane (top), (1 1 0)-plane (middle) and (1 1 1)-plane (bottom) of amidogen (NH$_2$) with  half the sites covered coverage} \label{NH2_summary_covered}
